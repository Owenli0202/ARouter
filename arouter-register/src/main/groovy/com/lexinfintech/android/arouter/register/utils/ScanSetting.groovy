 ...
 */
class ScanSetting {
    static final String PLUGIN_NAME = "com.lexinfintech.arouter"
    /**
     * The register code is generated into this class
     */
    static final String GENERATE_TO_CLASS_NAME = 'com/lexinfintech/android/arouter/core/LogisticsCenter'
    /**
     ...
     */
    static final String ROUTER_CLASS_PACKAGE_NAME = 'com/lexinfintech/android/arouter/routes/'
    /**
     * The package name of the interfaces
     */
    private static final INTERFACE_PACKAGE_NAME = 'com/lexinfintech/android/arouter/facade/template/'
