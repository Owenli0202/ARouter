package com.lexinfintech.android.arouter.compiler.utils;
...
public class TypeUtils {
    ...
    public TypeUtils(Types types, Elements elements) {
        ...
        parcelableType = this.elements.getTypeElement(Consts.PARCELABLE).asType();
        serializableType = this.elements.getTypeElement(Consts.SERIALIZABLE).asType();
    }
